      ...
      <Col xl={6} lg={7}>
        <Card className="auth-card border-0">
          <Card.Body className="p-4 p-lg-5">
            ...
            <h1 className="page-title fs-1">Đăng nhập người dùng thử nghiệm.</h1>
            <p className="page-subtitle">
              Lab04 chỉ yêu cầu mô phỏng trạng thái đăng nhập bằng React state.
              Ở đây bạn nhập `name` và `id`, sau đó frontend sẽ dùng thông tin
              này khi thêm, sửa hoặc xóa review.
            </p>
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3" controlId="loginName">
                ...
                <Form.Control
                  type="text"
                  placeholder="Ví dụ: NGO VAN THINHH"
                  value={name}
              ...
              <Form.Group className="mb-4" controlId="loginId">
                ...
                <Form.Control
                  type="text"
                  placeholder="Ví dụ: user-23521500"
                  value={id}
